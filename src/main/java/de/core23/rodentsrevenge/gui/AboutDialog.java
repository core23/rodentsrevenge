...
import de.core23.rodentsrevenge.component.JHyperlink;
...
public class AboutDialog extends JDialog {
	...
	private void initialize() {
		...
		this.setTitle(String.format(LanguageManager.getString("about.title"), "Rodent's Revenge")); //$NON-NLS-1$ //$NON-NLS-2$
	}
